...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/xazabcore-node:/insight/node_modules/@xazab/insight-ui/xazabcore-node`,
        `${rootPath}/po:/insight/node_modules/@xazab/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/@xazab/insight-ui/public`,
      ],
    };
