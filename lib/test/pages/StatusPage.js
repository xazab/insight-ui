function StatusPage() {
  ...
  const version = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[1]//td[2]"));
  const protocolVersion = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[2]//td[2]"));
  const blocks = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[3]//td[2]"));
  const timeOffset = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[4]//td[2]"));
  const connections = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[5]//td[2]"));
  const miningDifficulty = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[6]//td[2]"));
  const network = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[7]//td[2]"));
  const proxySetting = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[8]//td[2]"));
  const infoErrors = element(by.xpath("//h2[contains(text(), 'Xazab node information')]/../table//tr[9]//td[2]"));
